...
screen.setup(600,500)    #choosing the screen size
screen.bgcolor('black')    #making canvas black
trtl.pencolor('teal')    #making color of the pen ocean
...
trtl.pencolor('blue')    # choosin the pen colour as blue
trtl.write("Adrian's coding begins!", font=("Arial", 20, "bold")) # chosing the font
trtl.penup()
